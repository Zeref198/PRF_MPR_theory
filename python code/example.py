...
power = mpr.power(const_current=300e3,
                       const_mag=0.001) 
...
crit_waveNo, beta_crit = mpr.calculate_instability_onset(cryo, alum, gamma_int, dim, wavenumber_limit=6)
...
damp1,damp2 = mpr.calculate_viscous_damping(electrolyte=cryo, 
                                            metal=alum, 
...
print(f'Viscous damping rate of wave mode {wave1} and {wave2} is:', f'{damp1:.4f}, {damp2:.4f}')
...
print(f'For Sele parameter = {beta:.3f}, the growth rate of {wave1} and {wave2} is:', f'{gr:.4f}')
