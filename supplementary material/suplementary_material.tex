...
To derive the velocity potential ($\phi$) for each medium $i$, we need to solve the Laplace equation which goes by:
\begin{equation}
...
The Laplace equation for the electric potential reads:
\begin{equation}
...
\label{appA}
To recap, the two-wave perturbation ansatz reads
\begin{equation}
